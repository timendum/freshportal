type IconType = React.JSX.Element;

const faSquarePlus: IconType = (
  <svg
    aria-hidden="true"
    focusable="false"
...
const faMoon: IconType = (
  <svg
    aria-hidden="true"
    focusable="false"
    className="faIcon align-[-0.1em]"
    role="img"
    viewBox="0 0 448 512"
    width="1em"
    height="1em"
...
const faRightFromBracket: IconType = (
  <svg
    aria-hidden="true"
    focusable="false"
    className="faIcon align-[-0.125em]"
...
const faSpinner: IconType = (
  ...
  >
    <path
      fill="currentColor"
      d="M304 48a48 48 0 1 0-96 0a48 48 0 1 0 96 0m0 416a48 48 0 1 0-96 0a48 48 0 1 0 96 0M48 304a48 48 0 1 0 0-96a48 48 0 1 0 0 96m464-48a48 48 0 1 0-96 0a48 48 0 1 0 96 0M142.9 437A48 48 0 1 0 75 369.1a48 48 0 1 0 67.9 67.9m0-294.2A48 48 0 1 0 75 75a48 48 0 1 0 67.9 67.9zM369.1 437a48 48 0 1 0 67.9-67.9a48 48 0 1 0-67.9 67.9"
    />
  </svg>
);

const faCaretUp: IconType = (
  <svg
    aria-hidden="true"
    focusable="false"
    className="faIcon align-[-0.125em]"
...
const faUpDownLeftRight: IconType = (
  ...
  >
    <path
      fill="currentColor"
      d="M278.6 9.4c-12.5-12.5-32.8-12.5-45.3 0l-64 64c-9.2 9.2-11.9 22.9-6.9 34.9s16.6 19.8 29.6 19.8h32v96h-96v-32c0-12.9-7.8-24.6-19.8-29.6s-25.7-2.2-34.9 6.9l-64 64c-12.5 12.5-12.5 32.8 0 45.3l64 64c9.2 9.2 22.9 11.9 34.9 6.9S128 333 128 320v-32h96v96h-32c-12.9 0-24.6 7.8-29.6 19.8s-2.2 25.7 6.9 34.9l64 64c12.5 12.5 32.8 12.5 45.3 0l64-64c9.2-9.2 11.9-22.9 6.9-34.9S332.9 384 319.9 384h-32v-96h96v32c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l64-64c12.5-12.5 12.5-32.8 0-45.3l-64-64c-9.2-9.2-22.9-11.9-34.9-6.9s-19.8 16.6-19.8 29.6v32h-96v-96h32c12.9 0 24.6-7.8 29.6-19.8s2.2-25.7-6.9-34.9z"
    />
  </svg>
);
...
const faCircleXmark: IconType = (
  ...
  >
    <path
      fill="currentColor"
      d="M256 512a256 256 0 1 0 0-512a256 256 0 1 0 0 512m-81-337c9.4-9.4 24.6-9.4 33.9 0l47 47l47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47l47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47l-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47l-47-47c-9.4-9.4-9.4-24.6 0-33.9"
    />
  </svg>
);
